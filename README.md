...
### Introduction  
Our privacy policy will help you understand what information we collect at *My Safe Campus*, how *My Safe Campus* uses it, and what choices you have.
*My Safe Campus* built the *My Safe Campus* app as a free app. This SERVICE is provided by *My Safe Campus* at no cost and is intended for use as is.
...
Some of the services may use location information transmitted from users' mobile phones. We only use this information within the scope necessary for the designated service. The location of the device is transmitted to the designated first respondents and any contacts the user has added when the emergency button is clicked. This is to aid the recipients of the alert to quickly get to the aid of the sender.
